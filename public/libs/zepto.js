...
/* Zepto 1.2.0 - zepto event data ie ios3 detect gesture touch - zeptojs.com/license */
(function (global, factory) {
  if (typeof define === 'function' && define.amd) { define(function () { return factory(global) }) } else { factory(global) }
}(window, function (window) {
  var Zepto = (function () {
    var undefined; var key; var $; var classList; var emptyArray = []; var concat = emptyArray.concat; var filter = emptyArray.filter; var slice = emptyArray.slice
    ...
    zepto.matches = function (element, selector) {
      ...
      var match; var parent = element.parentNode; var temp = !parent
    ...
    function Z (dom, selector) {
      var i; var len = dom ? dom.length : 0
    ...
    $.isNumeric = function (val) {
      var num = Number(val); var type = typeof val
    ...
    $.map = function (elements, callback) {
      var value; var values = []; var i; var key
    ...
    $.fn = {
      ...
      closest: function (selector, context) {
        var nodes = []; var collection = typeof selector === 'object' && $(selector)
      ...
      wrapInner: function (structure) {
        var func = isFunction(structure)
        return this.each(function (index) {
          var self = $(this); var contents = self.contents()
      ...
      addClass: function (name) {
        ...
        return this.each(function (idx) {
          ...
          classList = []
          var cls = className(this); var newName = funcArg(this, name, idx, cls)
      ...
      toggleClass: function (name, when) {
        if (!name) return this
        return this.each(function (idx) {
          var $this = $(this); var names = funcArg(this, name, idx, className(this))
      ...
      position: function () {
        ...
        var parentOffset = rootNodeRE.test(offsetParent[0].nodeName) ? { top: 0, left: 0 } : offsetParent.offset()
    ...
    adjacencyOperators.forEach(function (operator, operatorIndex) {
      ...
      // arguments can be nodes, arrays of nodes, Zepto objects and HTML strings
        var argType; var nodes = $.map(arguments, function (arg) {
          var arr = []
          argType = type(arg)
          if (argType == 'array') {
        ...
        var parent; var copyByClone = this.length > 1
  ...
  ;(function ($) {
    ...
    function add (element, events, fn, data, selector, delegator, capture) {
      var id = zid(element); var set = (handlers[id] || (handlers[id] = []))
    ...
    function createProxy (event) {
      var key; var proxy = { originalEvent: event }
    ...
    $.fn.on = function (event, selector, data, callback, one) {
      var autoRemove; var delegator; var $this = this
      ...
      return $this.each(function (_, element) {
        ...
        if (selector) {
          delegator = function (e) {
            var evt; var match = $(e.target).closest(selector, element).get(0)
  ...
  'change select keydown keypress keyup error').split(' ').forEach(function (event) {
    ...
    $.Event = function (type, props) {
      ...
      var event = document.createEvent(specialEvents[type] || 'Events'); var bubbles = true
  ...
  ;(function ($) {
    var data = {}; var dataAttr = $.fn.data; var camelize = $.camelCase
    var exp = $.expando = 'Zepto' + (+new Date()); var emptyArray = []
    ...
    function getData (node, name) {
      var id = node[exp]; var store = id && data[id]
    ...
    $.hasData = function (elem) {
      var id = elem[exp]; var store = id && data[id]
    ...
    $.fn.removeData = function (names) {
      ...
      return this.each(function () {
        var id = this[exp]; var store = id && data[id]
        if (store) {
  ...
  ;(function (undefined) {
    ...
    if (Array.prototype.reduce === undefined) {
      Array.prototype.reduce = function (fun) {
        ...
        var t = Object(this); var len = t.length >>> 0; var k = 0; var accumulator
        if (typeof fun !== 'function') throw new TypeError()
        if (len == 0 && arguments.length == 1) throw new TypeError()

        if (arguments.length >= 2) { accumulator = arguments[1] } else {
          do {
            if (k in t) {
              accumulator = t[k++]
              break
  ...
  ;(function ($) {
    function detect (ua, platform) {
      var os = this.os = {}; var browser = this.browser = {}
  ...
  ;(function ($) {
    if ($.os.ios) {
      var gesture = {}; var gestureTimeout
      ...
      $(document).bind('gesturestart', function (e) {
        var now = Date.now(); var delta = now - (gesture.last || now)
  ...
  ;(function ($) {
    var touch = {}
    var touchTimeout; var tapTimeout; var swipeTimeout; var longTapTimeout
    var longTapDelay = 750
    var gesture
    var down; var up; var move
    var eventMap
    ...
    function setup (__eventMap) {
      var now; var delta; var deltaX = 0; var deltaY = 0; var firstTouch; var _isPointerType
